...
<html lang="en">
  <head>
    ...
    <title>Kas Kita | Aplikasi Pencatat Keuangan Kita</title>
    <link rel="icon" href="<?= BASEURL. '/assets/images/image-landing.ico' ?>">
    ...
    <link rel="stylesheet" href="<?= BASEURL . '/assets/css/my-style.css' ?>">
